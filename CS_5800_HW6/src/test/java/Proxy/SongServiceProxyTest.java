...
public class SongServiceProxyTest {
    ...
    /**
     * Test of searchById method, of class SongServiceProxy.
     */
    @Test
    public void testSearchById() {
        ...
        SongService instanceP = new SongServiceProxy(instanceS);
        int expResult = 2;
    ...
    /**
     * Test of searchByTitle method, of class SongServiceProxy.
     */
    @Test
    public void testSearchByTitle() {
        ...
        List<Song> result = instanceP.searchByTitle(title);
        assertEquals(expResult, result.get(0).getMetadata().getTitle());
    }

    /**
     * Test of searchByAlbum method, of class SongServiceProxy.
     */
    @Test
    public void testSearchByAlbum() {
        ...
        List<Song> result = instanceP.searchByAlbum(album);
        assertEquals(expResult, result.get(0).getMetadata().getAlbum());
    }

    /**
     * Test of printMetadat method, of class SongServiceProxy.
     */
    @Test
    public void testPrintMetadat() {
        System.out.println("printMetadat");
        Metadata instance = new Metadata(2,"Song A", "Artist 1", "Album A", 201);
        List<Song> library = new ArrayList<Song>();
        library.add(new Song(instance));
        RealSongService instanceS = new RealSongService(library);
        SongServiceProxy instanceP = new SongServiceProxy();
        instanceP.printMetadat();
    }
